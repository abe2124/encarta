...
<body> 
	<div id="nav">
		...
		<a href="viewtechnology.php">View Technology Information</a>
		<a href="" class="active">Delete Technology Information</a>
	...
	<div id="content"> 
		...
		<?php 
			...
			$select_query = "select info_id, tecinformation,emp_id from technology"; 
			
			$select_result = mysql_query($select_query);
			if(mysql_num_rows($select_result) > 0) {
				echo '<h3 style="text-align:center"> You can delete any of the following Technology Information! </h3>';
	echo '<table>
					<tr> 
				...
				while($row = mysql_fetch_row($select_result)) {
					echo '<tr><form action="deletetechno.php" method="post" onsubmit="return confirmDelete()">';
			...
			echo"'".$row[1]."'
				...
				echo '<p>There are no Technology Information currently registered in the system!</p>';
			}
