...
<body> 
	...
	<div id="content"> 
		<div id="upload">
				...
				<h4 style="text-align:center"> Uplod Information About Ethiopia government and laws</h4>
				<form action="uploadhumanmadhertige.php" method="POST" ">
					...
					$Idhr=$_POST['iname'];
						...
						$name=$_POST['name'];
							...
							if(!empty($Idher) &&!empty($Idhr)&& !empty($name) ){
									...
									$Uplodt= "insert into   lawgovt (info_id,lawinformation,emp_id)
