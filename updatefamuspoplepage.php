...
<body> 
	...
	<div id="content"> 
		<h3 style="text-align:center"> You can update the following famous people by changing the input fields! </h3>
		<?php 
		...
		<tr> 
			...
			while($row = mysql_fetch_row($select_result)) {
				echo "<tr><form action=updatefamuspople.php method=post>";
