...
<body> 
	<div id="nav">
		...
		<a href="viewpopulartalks.php">View poplar Talks </a>
		<a href="" class="active">Delete poplar Talks</a>
	...
	<div id="content"> 
		...
		<?php 
			...
			if(mysql_num_rows($select_result) > 0) {
				echo '<h3 style="text-align:center"> You can delete any of the following Ethiopian Talks Information! </h3>';
	echo '<table>
				<tr> 
				...
				while($row = mysql_fetch_row($select_result)) {
					echo '<tr><form action="deletepuplar.php" method="post" onsubmit="return confirmDelete()">';
			...
			echo"'".$row[1]."'
				...
				echo '<p>There are no Information currently registered in the system!</p>';
			}
