...
<body> 
	...
	<div id="content"> 
		<div id="upload">
				...
				<h4 style="text-align:center"> Uplod Information About Ethiopia Culture</h4>
				<form action="uploadculture.php" method="POST" ">
					...
					<?php
						...
						$name=$_POST['name'];
							...
							if(!empty($Idher) &&!empty($Idhr) && !empty($name) ){
									...
									$Uplodt= "insert into   culture (info_id,cultureinformation,emp_id)
