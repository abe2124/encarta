...
<body> 
	...
	<div id="content"> 
		<h3 style="text-align:center"> You can update the following ethio_history by changing the input fields! </h3>
		<?php 
			...
			while($row = mysql_fetch_row($select_result)) {
				echo "<tr><form action=updateethiohistory.php method=post>";
