...
<body> 
	...
	<div id="content"> 
		<h3 style="text-align:center"> You can update the following envaroment by changing the input fields! </h3>
		<?php 
		...
		echo '<table>
			...
			while($row = mysql_fetch_row($select_result)) {
				echo "<tr><form action=updateenvaroment.php method=post>";
