...
<body> 
	...
	<div id="content"> 
		<div id="upload">
				...
				<h4 style="text-align:center"> Uplod Information About Ethiopia Agriculture</h4>
				<form action="uploadagriculture.php" method="POST" ">
			...
			<input type="varcha(15)" name="name"> 
					...
					$Idhr=$_POST['iname'];
						...
						$name=$_POST['name'];
							...
							if(!empty($Idher)&&!empty($Idhr) && !empty($name) ){
							
									$Uplodt= "insert into   agriculture (info_id,agricultureinformation,emp_id)
									values ('".$Idhr."','".$Idher."','".$name."')";
