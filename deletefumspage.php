...
<body> 
	<div id="nav">
		...
		<a href="viewfamouspeople.php">View famous people Information</a>
		<a href="" class="active">Delete famous people Information</a>
	...
	<div id="content"> 
		...
		$select_query = "select info_id , faminformation,emp_id from famouspeople"; 
			
			$select_result = mysql_query($select_query);
			if(mysql_num_rows($select_result) > 0) {
				echo '<h3 style="text-align:center"> You can delete any of the following famous people! </h3>';
	echo '<table>
				<tr> 
				...
				while($row = mysql_fetch_row($select_result)) {
					echo '<tr><form action="deletefums.php" method="post" onsubmit="return confirmDelete()">';
			...
			echo"'".$row[1]."'
				...
				echo '<p>There are no famous people currently registered in the system!</p>';
			}
