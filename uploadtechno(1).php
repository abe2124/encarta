...
<body> 
	...
	<div id="content"> 
		<div id="upload">
				...
				<h4 style="text-align:center"> Uplod Information About Ethiopia Technology</h4>
				<form action="uploadtechno.php" method="POST" ">
					...
					$Idhr=$_POST['iname'];
						...
						$name=$_POST['name'];
							...
							if(!empty($Id) &&!empty($Idhr)&& !empty($name) ){
									...
									$Uplodt= "insert into   technology (info_id,tecinformation,emp_id)
									values ('".$Idhr."','".$Id."','".$name."')";
