...
<body> 
	...
	<div id="content"> 
		<div id="upload">
				...
				<h4 style="text-align:center"> Uplod Information About Ethiopia Sport</h4>
				<form action="uploadsport.php" method="POST" ">
					...
					$Idhr=$_POST['iname'];
						...
						$name=$_POST['name'];
							...
							if(!empty($Id)&&!empty($Idhr) && !empty($name) ){
									...
									$Uplodt= "insert into   sport (info_id,spoinformation,emp_id)
									values ('".$Idhr."','".$Id."','".$name."')";
