...
<body> 
	<div id="nav">
		...
		<a href="viewnheritage.php">View   Heritages Information</a>
		<a href="" class="active">Delete Heritages Information</a>
	...
	<div id="content"> 
		...
		<?php 
			...
			if(mysql_num_rows($select_result) > 0) {
				echo '<h3 style="text-align:center"> You can delete any of the following Natural Heritages Information! </h3>';
	echo '<table>
					<tr> 
				...
				while($row = mysql_fetch_row($select_result)) {
					echo '<tr><form action="deletenhert.php" method="post" onsubmit="return confirmDelete()">';
