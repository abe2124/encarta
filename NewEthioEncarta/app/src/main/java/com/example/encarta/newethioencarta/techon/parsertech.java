...
public class parsertech extends AsyncTask<Void,Integer,Integer> {
    ...
    public parsertech(Context c, String data, ListView lv) {
        this.c = c;
        this.data = data;
        this.lv = lv;
    }
    ...
    private int parse()
    {
        try
        {
            ...
            for(int i=0;i<ja.length();i++)
            {
                ...
                //RETRIOEVE NAME
                String name=jo.getString("tecinformation");
