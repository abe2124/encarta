...
public class MyAdamid extends BaseAdapter{
 ...
 */
    ...
    public MyAdamid(Context context, ArrayList<Integer> listid, ArrayList<String> namelist) {
    ...
    public View getView(int Position, View convertView, ViewGroup viewGroup) {
        ...
        if(convertView == null) {
            convertView = View.inflate(context, R.layout.activity_ethiomiddle, null);
        }
