...
public class MyAdaheritage extends BaseAdapter {

    private Context context;
    private ArrayList<Integer> listid;
    private ArrayList<String> namelist;

    public MyAdaheritage(Context context, ArrayList<Integer> listid, ArrayList<String> namelist) {
    ...
    public View getView(int Position, View convertView, ViewGroup viewGroup) {
        ...
        if(convertView == null) {
            convertView = View.inflate(context, R.layout.activity_heritage, null);
        }
        ImageView imges=convertView.findViewById(R.id.imageher);
        TextView textView=convertView.findViewById(R.id.textViewher);
