...
public class MyAdafromtw extends BaseAdapter{
    ...
    public MyAdafromtw(Context context, ArrayList<Integer> listid, ArrayList<String> namelist) {
    ...
    public View getView(int Position, View convertView, ViewGroup viewGroup) {
        ...
        if(convertView == null) {
            convertView = View.inflate(context, R.layout.activity_twodtoteffrom, null);
        }
