...
public class Modernethiopia extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MyAdamodern = new MyA(Modernethiopia.this, idimages, namelist);
        listView.setAdapter(MyAdamodern);
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if(position==0){
                    Intent ethhistory=new Intent(Modernethiopia.this,Twodtoteffrom.class);
                    startActivityForResult(ethhistory,0);
                }
                if(position==1){
                    Intent amhi=new Intent(Modernethiopia.this,Italianoccupation.class);
                    startActivityForResult(amhi,1);
                }
                if(position==2){
                    Intent l=new Intent(Modernethiopia.this,Worldwar.class);
                    startActivityForResult(l,2);
                }
                if(position==3){
                    Intent l=new Intent(Modernethiopia.this,Postworldwar.class);
                    startActivityForResult(l,3);
                }
                if(position==4){
                    Intent l=new Intent(Modernethiopia.this,Communistperiod.class);
                    startActivityForResult(l,4);
                }
                if(position==5){
                    Intent l=new Intent(Modernethiopia.this,Fdrpresent.class);
...
startActivity(intent);
    ...
    public ArrayList<String> getNamelist(){
        namelist=new ArrayList<>();
        namelist.add(getString( R.string.afterzemenemesafnt));
        namelist.add(getString( R.string.italocapation));
        namelist.add(getString( R.string.worldwar2));
        namelist.add(getString( R.string.postworldwar2));
        namelist.add(getString( R.string.comminstli));
        namelist.add(getString( R.string.today));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.languge) {
            Intent Setting=new Intent(Modernethiopia.this,Languge.class);
            startActivities(new Intent[]{Setting});
        }
        if (id == R.id.Gotohome) {
            Intent Setting=new Intent(Modernethiopia.this,Home.class);
            startActivities(new Intent[]{Setting});
        }
