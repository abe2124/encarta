...
public class Ethiomiddle extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ethiomiddle);
        ...
        MyAdamid = new MyA(Ethiomiddle.this, idimages, namelist);
        listView.setAdapter(MyAdamid);
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if(position==0){
                    Intent ethhistory=new Intent(Ethiomiddle.this,Zagwedincty.class);
                    startActivityForResult(ethhistory,0);
                }
                if(position==1){
                    Intent amhi=new Intent(Ethiomiddle.this,Solo.class);
                    startActivityForResult(amhi,1);
                }
                if(position==2){
                    Intent l=new Intent(Ethiomiddle.this,Oromom.class);
                    startActivityForResult(l,2);
                }
                if(position==3){
                    Intent l=new Intent(Ethiomiddle.this,Gonder.class);
...
startActivity(intent);
    ...
    public ArrayList<String> getNamelist(){
        namelist=new ArrayList<>();
        namelist.add(getString( R.string.zagwe_dynasty));
        namelist.add(getString( R.string.early_solomonic_pariod));
        namelist.add(getString( R.string.oromo_mov));
        namelist.add(getString( R.string.gondrian_pariod));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.languge) {
            Intent Setting=new Intent(Ethiomiddle.this,Languge.class);
            startActivities(new Intent[]{Setting});
        }
        if (id == R.id.Gotohome) {
            Intent Setting=new Intent(Ethiomiddle.this,Home.class);
            startActivities(new Intent[]{Setting});
        }
