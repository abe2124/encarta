...
public class Ethiopiaanisint extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MyAdamid = new MyA(Ethiopiaanisint.this, idimages, namelist);
        listView.setAdapter(MyAdamid);
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if(position==0){
                    Intent ethhistory=new Intent(Ethiopiaanisint.this,Etymology.class);
                    startActivityForResult(ethhistory,0);
                }
                if(position==1){
                    Intent amhi=new Intent(Ethiopiaanisint.this,Dmt.class);
                    startActivityForResult(amhi,1);
                }
                if(position==2){
                    Intent l=new Intent(Ethiopiaanisint.this,Axum.class);
...
startActivity(intent);
    ...
    public ArrayList<Integer> getList(){
        idimages=new ArrayList<>();
        idimages.add(R.drawable.lucy);
        idimages.add(R.drawable.dmt);
    ...
    public ArrayList<String> getNamelist(){
        namelist=new ArrayList<>();
        namelist.add(getString( R.string.etymolist));
        namelist.add(getString( R.string.damtlist));
        namelist.add(getString( R.string.axumlist));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.languge) {
            Intent Setting=new Intent(Ethiopiaanisint.this,Languge.class);
            startActivities(new Intent[]{Setting});
        }
        if (id == R.id.Gotohome) {
            Intent Setting=new Intent(Ethiopiaanisint.this,Home.class);
            startActivities(new Intent[]{Setting});
        }
