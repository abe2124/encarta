...
public class MyAaHumans extends BaseAdapter {

    private Context context;
    private ArrayList<Integer> listid;
    private ArrayList<String> namelist;

    public MyAaHumans(Context context, ArrayList<Integer> listid, ArrayList<String> namelist) {
    ...
    public View getView(int Position, View convertView, ViewGroup viewGroup) {
        ...
        if(convertView == null) {
            convertView = View.inflate(context, R.layout.activity_humans, null);
        }
