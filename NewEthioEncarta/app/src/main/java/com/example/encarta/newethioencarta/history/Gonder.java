...
public class Gonder extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MyAdgonder = new MyA(Gonder.this, idimages, namelist);
        listView.setAdapter(MyAdgonder);
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if(position==0){
                    Intent ethhistory=new Intent(Gonder.this,Gondarperiod.class);
                    startActivityForResult(ethhistory,0);
                }
                if(position==1){
                    Intent amhi=new Intent(Gonder.this,Aussasultanate.class);
                    startActivityForResult(amhi,1);
                }
                if(position==2){
                    Intent l=new Intent(Gonder.this,Zemenemesafint.class);
                    startActivityForResult(l,2);
                }
                if(position==3){
                    Intent l=new Intent(Gonder.this,Gonder.class);
...
startActivity(intent);
    ...
    public ArrayList<String> getNamelist(){
        namelist=new ArrayList<>();
        namelist.add(getString( R.string.erliygonderlist));
        namelist.add(getString( R.string.assasultalist));
        namelist.add(getString( R.string.zemenemesafnt4));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.languge) {
            Intent Setting=new Intent(Gonder.this,Languge.class);
            startActivities(new Intent[]{Setting});
        }
        if (id == R.id.Gotohome) {
            Intent Setting=new Intent(Gonder.this,Home.class);
            startActivities(new Intent[]{Setting});
        }
