...
public class Historys extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myAdapter = new MyA(Historys.this, idimages, namelist);
        listView.setAdapter(myAdapter);
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if(position==0){
                    Intent ethhistory=new Intent(Historys.this,Perehisory.class);
                    startActivityForResult(ethhistory,0);
                }
                if(position==1){
                    Intent amhi=new Intent(Historys.this,Ethiopiaanisint.class);
                    startActivityForResult(amhi,1);
                }
                if(position==2){
                    Intent l=new Intent(Historys.this,Ethiomiddle.class);
                    startActivityForResult(l,2);
                }
                if(position==3){
                    Intent l=new Intent(Historys.this,Modernethiopia.class);
...
startActivity(intent);
    ...
    public ArrayList<String> getNamelist(){
        namelist=new ArrayList<>();
        namelist.add(getString( R.string.prehistory));
        namelist.add(getString( R.string.anitentethiopiahistory));
        namelist.add(getString( R.string.ethiomiddlhistory));
        namelist.add(getString( R.string.modernethiopiahistory));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.languge) {
            Intent Setting=new Intent(Historys.this,Languge.class);
            startActivities(new Intent[]{Setting});
        }
        if (id == R.id.Gotohome) {
            Intent Setting=new Intent(Historys.this,Home.class);
            startActivities(new Intent[]{Setting});
        }
