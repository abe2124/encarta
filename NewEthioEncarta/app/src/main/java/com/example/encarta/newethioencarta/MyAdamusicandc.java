...
public class MyAdamusicandc extends BaseAdapter {

    private Context context;
    private ArrayList<Integer> listid;
    private ArrayList<String> namelist;

    public MyAdamusicandc(Context context, ArrayList<Integer> listid, ArrayList<String> namelist) {
    ...
    public View getView(int Position, View convertView, ViewGroup viewGroup) {
        ...
        if(convertView == null) {
            convertView = View.inflate(context, R.layout.activity_musicandc, null);
        }
        ImageView imges=convertView.findViewById(R.id.imagemusicc);
        TextView textView=convertView.findViewById(R.id.textViewmusicc);
