...
public class MyAdascincen extends BaseAdapter {

    private Context context;
    private ArrayList<Integer> listid;
    private ArrayList<String> namelist;

    public MyAdascincen(Context context, ArrayList<Integer> listid, ArrayList<String> namelist) {
    ...
    public View getView(int Position, View convertView, ViewGroup viewGroup) {
        ...
        if(convertView == null) {
            convertView = View.inflate(context, R.layout.activity_scince_and__nature, null);
        }
        ImageView imges=convertView.findViewById(R.id.imagescincen);
        TextView textView=convertView.findViewById(R.id.textViewscincen);
