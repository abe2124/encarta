...
<body> 
	...
	<div id="content"> 
		<div id="upload">
				...
				<h4 style="text-align:center"> Uplod Information About Ethiopia Fumes people</h4>
				<form action="uploadfaumspeople.php" method="POST" ">
					...
					$Idhr=$_POST['iname'];
						...
						$name=$_POST['name'];
							...
							if(!empty($Idher)&&!empty($Idhr) && !empty($name) ){
									...
									$Uplodt= "insert into   famouspeople (info_id,faminformation,emp_id)
