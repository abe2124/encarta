...
<body> 
	...
	<div id="content"> 
		<div id="upload">
				...
				<h4 style="text-align:center"> Uplod Information About Ethiopia Popular tulks</h4>
				<form action="uploadpopulartalks.php" method="POST" ">
					...
					$Idhr=$_POST['iname'];
						...
						$name=$_POST['name'];
							...
							if(!empty($Id)&&!empty($Idhr) && !empty($name) ){
									...
									$Uplodt= "insert into   ethiopiajokes (info_id,jokinformation,emp_id)
									values ('".$Idhr."','".$Id."','".$name."')";
