...
<body> 
	...
	<div id="content"> 
		<h3 style="text-align:center"> You can update the following human heritage by changing the input fields! </h3>
		<?php 
		...
		<tr> 
			...
			while($row = mysql_fetch_row($select_result)) {
				echo "<tr><form action=updatehheritage.php method=post>";
