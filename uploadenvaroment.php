...
<body> 
	...
	<div id="content"> 
		<div id="upload">
				...
				<h4 style="text-align:center"> Uplod Information About Ethiopia Environment</h4>
				<form action="uploadenvaroment.php" method="POST" ">
					...
					$Idhr=$_POST['iname'];
						...
						$name=$_POST['name'];
							...
							if(!empty($Idher)&&!empty($Idhr) && !empty($name) ){
									...
									$Uplodt= "insert into   envaroment (info_id,envinformation,emp_id)
