...
<body> 
	<div id="nav">
		...
		<a href="viewmusicalhistory.php">View Musical History Information</a>
		<a href="" class="active">Delete Musical History Information</a>
	...
	<div id="content"> 
		...
		<?php 
			...
			if(mysql_num_rows($select_result) > 0) {
				echo '<h3 style="text-align:center"> You can delete any of the following Musical History! </h3>';
	echo '<table>
				<tr> 
				...
				while($row = mysql_fetch_row($select_result)) {
					echo '<tr><form action="deletemushi.php" method="post" onsubmit="return confirmDelete()">';
			...
			echo"'".$row[1]."'
				...
				echo '<p>There are no Musical History currently registered in the system!</p>';
			}
