...
<body> 
	...
	<div id="content"> 
		<h3 style="text-align:center"> You can update the following natural heritage by changing the input fields! </h3>
		<?php 
		...
		<tr> 
			...
			while($row = mysql_fetch_row($select_result)) {
				echo "<tr><form action=updatenhertig.php method=post>";
