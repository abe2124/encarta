...
<body> 
	...
	<div id="content"> 
		<div id="upload">
				...
				<h4 style="text-align:center"> Uplod Information About Ethiopia Educations</h4>
				<form action="uploadeducation.php" method="POST" ">
					...
					$Idhr=$_POST['iname'];
						...
						$name=$_POST['name'];
							...
							if(!empty($Idher)&&!empty($Idhr) && !empty($name) ){
									...
									$Uplodt= "insert into  education (info_id,eduinformation,emp_id)
