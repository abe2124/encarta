...
<body> 
	<div id="nav">
		...
		<a href="viewsport.php">View Sport Information</a>
		<a href="" class="active">Delete Sport Information</a>
	...
	<div id="content"> 
		...
		$select_query = "select info_id, spoinformation,emp_id from sport"; 
			...
			if(mysql_num_rows($select_result) > 0) {
				echo '<h3 style="text-align:center"> You can delete any of the following Sport Information! </h3>';
	echo '<table>
					<tr> 
				...
				while($row = mysql_fetch_row($select_result)) {
					echo '<tr><form action="deletesport.php" method="post" onsubmit="return confirmDelete()">';
