...
<body> 
	<div id="nav">
		...
		<a href="vieweducation.php">View Ethiopian Cultures Information</a>
		<a href="" class="active">Delete Ethiopian Cultures Information</a>
	...
	<div id="content"> 
		...
		<?php 
			...
			if(mysql_num_rows($select_result) > 0) {
				echo '<h3 style="text-align:center"> You can delete any of the following Ethiopian Cultures Information! </h3>';
	echo '<table>
	<tr> 
			...
			echo"'".$row[1]."'
				...
				echo '<p>There are no Ethiopian Cultures Information currently registered in the system!</p>';
			}
