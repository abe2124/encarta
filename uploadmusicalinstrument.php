...
<body> 
	...
	<div id="content"> 
		<div id="upload">
				...
				<h4 style="text-align:center"> Uplod Information About Ethiopia Musical Instrument</h4>
				<form action="uploadmusicalinstrument.php" method="POST" ">
					...
					$Idhr=$_POST['iname'];
						...
						$name=$_POST['name'];
							...
							if(!empty($Id)&&!empty($Idhr) && !empty($name) ){
									...
									$Uplodt= "insert into   musicalinformation (info_id,musinformation,emp_id)
									values ('".$Idhr."','".$Id."','".$name."')";
